...
The comparison for the correlations between A1,C1 and E1,O1 was $\Delta r$ = -.001, 95% CI [-.11,.09], *n* = 759. 

# Comparing the correlation between (A1, C1) to the correlation between (A1, E1).

The comparison for the correlations between A1,C1 and A1,E1 was $\Delta r$ = -.080, 95% CI [-.18,.02], *n* = 764. 

# Comparing the (A1,E1) correlations for men and women.

The comparison for the correlations between A1,E1 between men and women was $\Delta r$ = .017, 95% CI [-.13,.16], *n* = 251 for men and *n* = 518 for women. 

# Comparing Rating-Raises correlation with Rating-Critical Correlation

The comparison for the correlations between ratings and raises and ratings and critical was $\Delta r$ = .43, 95% CI [.07,.79], N = 30. 

# Comparing Rating-Raises correlation with complaints-Critical Correlation

The comparison for the correlations between ratings and raises and complaints and critical was $\Delta r$ = .40, 95% CI [.01,.78], N = 30. 
